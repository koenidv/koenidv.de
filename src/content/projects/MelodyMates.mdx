...
import image1 from "../../../public/images/melodymates/1.png";
import image2 from "../../../public/images/melodymates/2.png";
import image3 from "../../../public/images/melodymates/3.png";
import image4 from "../../../public/images/melodymates/4.png";
...
<div class="imagecarousel flex flex-row gap-2 overflow-x-scroll rounded">
  {
    [
      ...
      ["User Profile", image2],
      ["Post", image3],
      ["Search Screen", image4]
    ].map(([description, image], index) => (
      <a
        target="_blank"
        class="transition-all duration-200 hover:saturate-100 lg:saturate-0"
        href={`/images/melodymates/${index + 1}.png`}>
        <Image
          src={image}
          alt={`Screenshot from MelodyMates; ${description}`}
					widths={[200, 400, 800]}
...
<p>
	...
	, for example, found that "the social context provided by music can strengthen interpersonal closeness
